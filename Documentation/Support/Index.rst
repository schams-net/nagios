...
TYPO3 is a community-driven project with a huge basis of developers. You can ask questions in one of the community areas (e.g. TYPO3 forum, mailing lists, on IRC, etc.). Find TYPO3 support options at: `http://typo3.org/support <http://typo3.org/support/>`_. Alternatively, feel free to contact the author of the TYPO3 extension directly `schams.net <http://schams.net/>`_ .
...
Read more about contributions, sponsorship options and commercial/non-commercial support at: `schams.net <http://schams.net/>`_. You may also want to consider to use the commercial version of Nagios®, see: `www.nagios.com <http://www.nagios.com/>`_.
